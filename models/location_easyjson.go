...
func easyjson14b80819DecodeHlModels(in *jlexer.Lexer, out *Locations) {
...
func easyjson14b80819EncodeHlModels(out *jwriter.Writer, in Locations) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v Locations) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson14b80819EncodeHlModels(&w, v)
...
func (v *Locations) UnmarshalJSON(data []byte) error {
	...
	easyjson14b80819DecodeHlModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Locations) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson14b80819DecodeHlModels(l, v)
}
func easyjson14b80819DecodeHlModels1(in *jlexer.Lexer, out *Location) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson14b80819EncodeHlModels1(out *jwriter.Writer, in Location) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v Location) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson14b80819EncodeHlModels1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Location) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson14b80819DecodeHlModels1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Location) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson14b80819DecodeHlModels1(l, v)
}
